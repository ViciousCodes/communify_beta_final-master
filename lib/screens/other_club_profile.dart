...
import 'package:communify_beta_final/bloc/ViewClubProfileBloc/view_club_profile_bloc.dart';
...
class ViewClubProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ViewClubProfileBloc()..add(LoadClubProfileData(club: club)),
      child: Scaffold(
        backgroundColor: CupertinoColors.white,
        body: BlocBuilder<ViewClubProfileBloc, ViewClubProfileState>(
          builder: (context, state) {
            if (state is ViewClubProfileLoading) {
              return const Center(child: CupertinoActivityIndicator(color: Color(0xFF09152D)));
            } else if (state is ViewClubProfileLoaded) {
            ...
            } else if (state is ViewClubProfileError) {
